    ...
    <div class="flex flex-col w-64 max-h-64 overflow-y-auto border-l border-t border-r border-b border-gray-200 rounded-lg">
        ...
        <div class="flex flex-col space-y-2 p-2">
            ...
            <div class="flex justify-between items-center">
                <div>Industry:</div>
                <div class="font-bold">${
                  user.typeDescription || user.type
                }</div>
            </div>
            <div class="flex justify-between items-center">
            ...
            <div class="flex justify-center items-center bg-lime-400 shadow-lg shadow-lime-200 select-none outline-none text-white rounded-md px-3 py-2 cursor-pointer" id="viewProfileButton">View Profile</div>
        </div>
    </div>
  `;
};
